      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
            <div class="row">
              <div class="col-xs-12">
                <h4 class="page-title">Delete Vendors</h4>
              </div> 
            </div>
			<!-- PAGE CONTENT HERE -------------------------->
            ...
            <tbody>
                <?php foreach ($Vendors as $Vendor): ?>
                    <tr>
                        ...
                        <td>
                        <form id="VendorsForm" method="post" action="<?php echo admin_url('mcm/DeleteVendor'); ?>">
                        ...
                        <button type="Delete" class="btn btn-primary mt-3">Delete Vendor</button>
                        </form>
